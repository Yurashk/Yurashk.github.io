...
<body>
	<ul class="topnav" id="myTopnav">
		<canvas class="canvas" src="canvas.js" style="color:white;" id="canvas">msv</canvas><div>
		<script src="canvas.js"></script>
		<li><a href="mi.php" class="active">Home</a></li>
		<li><a href="" >News</a></li>
		<li><a href="obratka.php" >Contacts</a></li>
			...
			<div id="articless">
				...
				<article id="senterbl">
					<div class="slideshow-conteiner">
						...
						<div class="mySlides fade">
			<a  class="next"  href="mi.php" ><img src="images/universal.jpg"style="cursor:pointer" width="100%" height="100%" alt=""></a>
		</div>
	</div>
	<hr>
